      ...
      <div v-if="slice.items.length" class="mt-10">
        <div id="feature" class="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-10">
          <div
            ...
            >
            <div class="mx-auto">
              <prismic-image class="hidden md:block mx-auto md:object-contain md:h-56" :field="feature.image" />
              <prismic-image class="block md:hidden mx-auto" :field="feature.image.mobile" />
            </div>
